...
return [
    ...
    //验证码配置
    'captcha'                => [
        'codeSet'  => '123456789',  // 验证码字符集合,仅数字，减少输入难度（可选）
        'fontSize' => 18,           // 验证码字体大小(px)
        'imageH'   => 40,           // 验证码图片高度
        'imageW'   => 130,          // 验证码图片宽度（适配手机竖屏）
        'useCurve' => false,        // 关闭干扰曲线（提升移动端识别率）
        'useNoise' => true,         // 保留噪点（防止机器识别）
        'useZh'    => false,        //使用中文验证码
        'length'   => 4,            // 4位验证码（简化输入）
        'bg'       => [255, 255, 255], // 白色背景（对比度高）
        'fontttf'  => '',           // 可选：指定清晰字体文件（如手机端专用字体）
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'ytew5S9MLON7CHxEATo3bcqaBW6Psr40',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
